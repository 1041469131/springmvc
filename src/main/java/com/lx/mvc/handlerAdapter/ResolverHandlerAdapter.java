package com.lx.mvc.handlerAdapter;
...
import com.lx.mvc.argumentResolver.ArgumentResolver;

@Service("ResolverHandlerAdapter")
public class ResolverHandlerAdapter implements HandlerAdapter {
